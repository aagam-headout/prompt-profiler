...
A Node CLI that reads your local **Claude Code** and **Cursor** session history
and distills it into prompting-style **signals** — technical depth,
authenticity/engagement, independence, plus a style fingerprint, metrics, and
behavioral markers.

> ⚠ **Read this.** Every score is a *heuristic signal for a human reviewer*, not
...
|---------|--------------|
| `list` | List all sources (Claude Code workspaces + Cursor). |
