...
const LANG_MAP = {
  typescriptreact: 'TypeScript (React)', typescript: 'TypeScript', javascriptreact: 'JavaScript (React)',
  javascript: 'JavaScript', python: 'Python', shellscript: 'Shell', bash: 'Shell', json: 'JSON',
  jsonc: 'JSON', markdown: 'Markdown', html: 'HTML', css: 'CSS', scss: 'SCSS', go: 'Go', rust: 'Rust',
  java: 'Java', ruby: 'Ruby', php: 'PHP', sql: 'SQL', yaml: 'YAML', plaintext: 'Plain text',
  cpp: 'C++', c: 'C', csharp: 'C#', swift: 'Swift', kotlin: 'Kotlin', dart: 'Dart', vue: 'Vue',
  graphql: 'GraphQL', dockerfile: 'Dockerfile', xml: 'XML',
};
...
function cursorLanguages() {
  ...
  return Object.entries(agg).sort((a, b) => b[1] - a[1]).map(([lang, count]) => ({ lang, count }));
}
